...
private:
    static inline __m128i_u rotl(const __m128i_u x, int k)
    {
...
private:
    static inline __m256i_u rotl(const __m256i_u x, int k)
    {
...
private:
    static inline __m512i_u rotl(const __m512i_u x, int k)
    {
